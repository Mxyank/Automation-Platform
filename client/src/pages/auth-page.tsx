...
export default function AuthPage() {
  ...
  return (
    <div className="h-screen bg-dark-bg flex flex-col md:flex-row overflow-hidden">
      {/* Left Panel: Premium Showcase */}
      <div className="hidden md:flex flex-1 relative items-start justify-center p-12 bg-[#0A0D12] overflow-y-auto border-r border-gray-800">
      ...
      {/* Right Panel: Auth Forms — pinned to center independently */}
      <div className="flex-1 flex flex-col items-center justify-center p-8 bg-dark-bg relative overflow-y-auto min-h-0">
        {/* Back to Home */}
        <a
          href="/"
        ...
        <div className="w-full max-w-md space-y-8 relative z-10 py-12">
          ...
          <Tabs defaultValue="login" className="w-full">
            <TabsList className="grid w-full grid-cols-2 bg-[#161B22] border border-gray-800 rounded-xl p-1 mb-8 shadow-inner h-14">
              <TabsTrigger value="login" className="text-gray-400 data-[state=active]:bg-white data-[state=active]:text-black data-[state=active]:shadow-md rounded-lg transition-all duration-300 h-full font-semibold text-sm">Sign In</TabsTrigger>
              <TabsTrigger value="register" className="text-gray-400 data-[state=active]:bg-white data-[state=active]:text-black data-[state=active]:shadow-md rounded-lg transition-all duration-300 h-full font-semibold text-sm">Sign Up</TabsTrigger>
            </TabsList>
                ...
                <CardContent className="space-y-6">
                  <div className="grid grid-cols-2 gap-3">
                    <button
                      ...
                      className="flex items-center justify-center gap-2 px-4 py-3 bg-white hover:bg-gray-100 text-gray-900 font-bold rounded-xl transition-all shadow-lg active:scale-95"
                    >
                    ...
                    <button
                      ...
                      className="flex items-center justify-center gap-2 px-4 py-3 bg-[#24292e] hover:bg-[#2f363d] text-white font-bold rounded-xl transition-all shadow-lg active:scale-95"
                    >
